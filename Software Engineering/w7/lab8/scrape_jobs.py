...
def scrape_jobs(chromedriver_path, url):
    ...
    for job_element in job_elements:
        ...
        job["company"] = job_element.find_element(By.CLASS_NAME, "card__job-empname-label").text
        
        try:
            job["image_url"] = job_element.find_element(By.CLASS_NAME, "card__job-logo").get_attribute("src")
        except:
            job["image_url"]= None
